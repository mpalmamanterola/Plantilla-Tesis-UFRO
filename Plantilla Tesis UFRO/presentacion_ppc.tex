...
%The next statement creates the title page.
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[height=0.7\textheight]{images/GRACE_init.png}
      \end{column}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[height= 0.7\textheight]{images/cr2met.png}
      \end{column}
    \end{columns}
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Wells_with_landcover_coq.jpeg}
      \end{column}

      \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Pixel1_and_pixels025_to_validate.png}
      \end{column}
  ...
  \begin{frame}
    ...
    \centering
    \includegraphics[width=\textwidth]{images/Anomalies_pixel-7125S-3075W_1.png}
  \end{frame}
  ...
  \begin{frame}
    ...
    \centering
    \includegraphics[scale=0.66]{images/area_with_high_differences_cdorf.png}
