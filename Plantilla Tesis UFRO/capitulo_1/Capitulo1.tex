...
fiscalización alguna \cite{28}. La sobreexplotación de los almacenes de agua subterránea ha generado que su nivel 
continúe disminuyendo, provocando desastres como hundimientos de suelo, pérdida de volumen a través de la
separación de un acuífero, el secado de zonas húmedas y aparición de conos de presión \cite{29}.
...
del almacenamiento de agua a nivel espacial, este es el satélite GRACE, el cual a través de 
...
En base a las anomalías se pueden definir ciertos rangos de comportamientos de las mediciones que se detallan en la figura \ref{logo1}, en ella se puede observar que para la anomalía TWS, si esta se encuentra en el intervalo $[-2,-1[$
...
Implementar \textit{Downscaling} a los datos satelitales GRACE a través de un modelo predictivo para obtener 
...
\begin{itemize}
    \item Definir la metodología del \textit{Downscaling}.
