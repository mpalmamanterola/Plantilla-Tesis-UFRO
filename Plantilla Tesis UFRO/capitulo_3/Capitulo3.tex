...
Finalmente, luego de haber activado la máquina virtual en \textit{gcp} que se desea utilizar se procede a conectar la máquina virtual \ref{sshconec} con la dirección IP del computador personal o de quien realiza la consulta para la conexión
...
\begin{figure}[H]\label{sshconec}
    \centering
          \includegraphics[width=0.8\linewidth]{images/ssh-conection.png}
