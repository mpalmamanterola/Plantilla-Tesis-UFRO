...
Otra de las herramientas utilizadas durante todo el proceso fue la creación de una Máquina Vritual(VM por sus siglas en inlés \textit{Virtual Machine}) de acuerdo a las necesidaes mediante la instancia
...
\begin{figure}[ht]
    \centering
          \includegraphics[scale=0.6]{images/ssh-conection.png}
...
69.5°S, el cual corresponde a todo el territorio continental chileno.
    ...
    En la figura se aprecia que existen dos variables involucradas en el dataset, \textit{lwe\_thickness} (abreviación del inglés
    ...
    del territorio chileno, la \textbf{fecha de la medición}, las cuales se encontraban distanciadas diariamente con valores faltantes y finalmente el valor de la \textbf{profundidad del pozo},
...
\section{Entrenamiento y Testeo}
    ...
    \begin{figure}[ht]
        \centering
              \includegraphics[scale=0.5]{images/division_zonas.png}
              \vskip -0.1in
    ...
    \begin{figure}[ht]
        \centering
              \includegraphics[scale=0.5]{images/traintest.png}
              \vskip -0.1in
...
\begin{figure}[h]
    \centering
          \includegraphics[scale=0.5]{images/RF_regressor.png}
          \vskip -0.1in
...
\begin{figure}[h]
    \centering
          \includegraphics[scale=0.5]{images/RF_regressor_mae.png}
          \vskip -0.1in
...
\end{figure}
    ...
    \begin{figure}[H]
        \centering
              \includegraphics[scale=0.5]{images/res_interp.png}
              \vskip -0.1in
    ...
    \begin{figure}[H]
        \centering
              \includegraphics[scale=0.5]{images/res_interp_rutine.png}
              \vskip -0.1in
