...
\begin{table}[H] 
    \caption[Varianzas en parche con altas diferencias entre CDO y RF]{Varianzas en parche con altas diferencias entre interpolación bilinear con CDO y regresión mediante RF}
    \newcolumntype{C}{>{\centering\arraybackslash}X}
...
\begin{figure}[H]
    \centering
          \subfigure[Interpoalción bilinear]{\includegraphics[scale=0.53]{images/rfvbil_2002.png}}
          \subfigure[TWS a 0.25$^{\circ}$ ]{\includegraphics[scale=0.53]{images/bilvrf_2002.png}}
          \vskip -0.1in
...
\begin{figure}[H]
    \centering
          \subfigure[Interpoalción bilinear]{\includegraphics[scale=0.53]{images/rfvbil_2014.png}}
          \subfigure[TWS a 0.25$^{\circ}$ ]{\includegraphics[scale=0.53]{images/bilvrf_2014.png}}
          \vskip -0.1in
