...
Debido a la extensa hidrografía presente en el territorio chileno y de los limitados datos de observaciones de pozos, la validación y la discusión mediante mediciones \textit{in situ} se centrará
en la región de Coquimbo. En primera instancia se realiza un estudio general de datos promediados regionales para observar los comportamientos de la región y 
posteriormente escoger un pixel en particular de pozos para estudiar series de tiempo particulares.
%
% 
